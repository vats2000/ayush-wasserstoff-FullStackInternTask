...
function Temperature({ setCity, stats }) {
  ...
  return (
    <>
      <div className="flex align-middle justify-center text-tranform scale-100 hover:scale-110 cursor-pointer transition-transform duration-300 ease-in-out">
        <input
          type="text"
      ...
      <div className="flex justify-center items-center text-slate-200 mt-8 text-tranform scale-100 hover:scale-110 cursor-pointer transition-transform duration-300 ease-in-out">
